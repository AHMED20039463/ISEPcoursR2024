...
library(haven)
cereales <- read_dta("C:/Users/pc/Downloads/cereales.dta")
View(cereales)
#Renommer variables
...
#Découpage en classe de la classe 
Qtty_cons
...
library(readxl)
conversion <- read_excel("C:/Users/pc/Desktop/Cours R/Table de conversion phase 2.xlsx")
View(conversion)
